...
/**
 * @description: 账号-关系维度信息(AccountRelationships)VO类
...
public class AccountRelationshipsVo implements Serializable {
    private static final long serialVersionUID = -20092273690430615L;
