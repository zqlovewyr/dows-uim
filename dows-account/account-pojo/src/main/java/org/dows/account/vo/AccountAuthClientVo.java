...
/**
 * @description: 账号-授权客户端(AccountAuthClient)VO类
...
public class AccountAuthClientVo implements Serializable {
    private static final long serialVersionUID = -23655630728467400L;
