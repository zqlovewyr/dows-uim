...
/**
 * @description: 账号-操作记录维度信息(AccountLogs)Query类
...
public class AccountLogsQuery implements Serializable {
    private static final long serialVersionUID = 226232303659960434L;
