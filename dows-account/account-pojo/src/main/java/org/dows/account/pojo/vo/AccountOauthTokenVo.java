...
/**
 * @description: 账号-第三方账号授权(AccountOauthToken)VO类
...
public class AccountOauthTokenVo implements Serializable {
    private static final long serialVersionUID = -92776868591644957L;
