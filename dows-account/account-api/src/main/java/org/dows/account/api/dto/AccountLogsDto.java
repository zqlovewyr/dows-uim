...
/**
 * @description: 账号-操作记录维度信息(AccountLogs)DTO类
...
public class AccountLogsDto implements Serializable {
    private static final long serialVersionUID = -86708407337001119L;
