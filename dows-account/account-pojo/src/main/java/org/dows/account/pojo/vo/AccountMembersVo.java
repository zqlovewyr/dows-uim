...
/**
 * @description: 账号-会员维度信息(AccountMembers)VO类
...
public class AccountMembersVo implements Serializable {
    private static final long serialVersionUID = -28296129237215027L;
