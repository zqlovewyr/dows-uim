...
@RestController
@RequestMapping("admin/account/feedback")
public class AdminAccountFeedbackRest implements MybatisCrudRest<AccountFeedbackForm, AccountFeedback, AccountFeedbackService> {
